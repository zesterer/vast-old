...
namespace Vast
{
	...
	public:
		...
		Vertex::Format getVertexFormat() { return this->vert_format; }
		...
		bool init();
		void unload();
		bool load(const gl::GLfloat* vertices, size_t vert_size, unsigned long vert_count, Vertex::Format vert_format);
